...
> _instead of stdout the string "HELLO WORLD", this text is saved into test_file.txt_
...
> What changed?
>> The format of file size is changed from number of bits to its abbreviation
